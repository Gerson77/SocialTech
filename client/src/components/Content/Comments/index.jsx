...
export default function Comments({
  ...
  return (
    <div>
      {text.length >= 47 ? (
        <div className="w-full flex border-t-[1px] dark:border-gray-400 border-gray-200 group">
          <div className="w-[10%] mt-2">
            <img src={image} alt="user" className="w-10 h-10 rounded-full" />
          </div>
          <div className="w-[85%] mt-2 flex flex-col justify-end">
            <p
              className={`${viewMore
                ? 'h-auto'
          ...
          {friendId === user.id && (
            <div className="flex items-center justify-center w-[5%] h-8 mt-2 invisible group-hover:visible">
              <Trash2
        ...
        <div className="w-full items-center group flex mb-2 border-t-[1px] dark:border-gray-400 border-gray-200">
          <div className="w-[10%] mt-2">
          ...
          {friendId === user.id && (
          <div className="w-[5%] h-8 mt-2 invisible group-hover:visible">
